...
```
cd existing_repo
git remote add origin https://gitlab.leibniz-lib.de/vnathan/snpstr-genotyping.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.leibniz-lib.de/vnathan/snpstr-genotyping/-/settings/integrations)
