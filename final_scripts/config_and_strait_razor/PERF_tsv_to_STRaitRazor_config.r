...
perf_input <- as.data.frame(read.table("PrimerRef_perf.tsv")) #could have off-by-one

fasta_sequences <- readLines("PrimerRef.fasta")
...
for(primer in 1:30)
{
    ...
    write.table(output_df, paste("./config/",perf_input[primer,1],
